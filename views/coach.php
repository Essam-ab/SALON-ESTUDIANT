    ...
    <style>
        ...
        @media screen and (max-width:600px) {
            ...
            .stand_library .box .details {
                ...
                background: black;
                color: white;
                border-bottom: 5px solid #7b33d2
            }

            .stand_library .box .details h2 {
    ...
    <div class="all-content">
        ...
        <div class="icons_container container">
            <div class="icons_left">
                <a class="me-right">
                    <i class="fas fa-arrow-left" name="standLogout" id="home_view" tabindex="0" data-toggle="tooltip" title="Revenir au stand"></i>
                </a>
